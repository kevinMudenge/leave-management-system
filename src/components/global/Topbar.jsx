    ...
    >
      <Box display="flex" alignItems="center">
        ...
        <Box display="flex" gap={4} pl={{ sm: 7, xs: 1 }}>
          <Button
            variant={
              location.pathname === "/dashboard/app" ? "contained" : "text"
            }
          ...
          <Button
            variant={
              location.pathname === "/dashboard/leaveapplication"
                ? "contained"
                : "text"
            }
            color={
          ...
          <Button
            variant={
              location.pathname === "/dashboard/leavetracker"
                ? "contained"
                : "text"
            }
            color={
              location.pathname === "/dashboard/leavetracker" ? "error" : "info"
            }
            component={RouterLink}
            size="small"
          ...
          <Button
            variant={
              location.pathname === "/dashboard/leavepolicy"
                ? "contained"
                : "text"
            }
            color={
              location.pathname === "/dashboard/leavepolicy" ? "error" : "info"
            }
            component={RouterLink}
      ...
      <Box display="flex" alignItems="center">
        ...
        <Chip
          ...
          deleteIcon={
            <Tooltip title="Open settings" arrow placement="bottom-end">
              <ArrowDropDownIcon />
            </Tooltip>
          }
        />
      ...
      >
        ...
        component={RouterLink} to="/dashboard/profile">
          <IconButton>
